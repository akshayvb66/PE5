...
public class MainTest {
    ...
    public static void main(String []args) {
        ...
        Student ob1 = new Student(143, "Akshay", 22);


        Student ob2 = new Student(123, "Uday", 23);


        Student ob3 = new Student(234, "Sairam", 21);


        Student ob4 = new Student(104, "Naneeth", 28);


        Student ob5 = new Student(177, "Gaurav", 22);
